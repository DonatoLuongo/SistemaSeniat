                    ...
                    <div class="form-container">
                        ...
                        <div class="row">
                            ...
                            <div class="TituloModulo">
                                <h3 class="lead-text"> Agregar Licor </h3>
                            </div>

                            <form action="crudAgregarLicor.php" method="POST">
                                <div class="user-details">

                                    <div class="input-box">
                                        <label class="detail" for="apelli">Nombre</label>
                                        <input type="text" placeholder="Nombre del nuevo producto" name="nombre_licor" id="apellido_visitante" required>
                                    </div>
