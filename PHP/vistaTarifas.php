            ...
            <table> <!--    Tabla para mostrar informacion "Datos" y la opcion de editar "Modificar"  -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <strong> <a class="buttonlist" href="../PHP/vistaTarifaCanonArrendamiento.php">Mostrar</a> </strong> </td>
                    </tr>
                    <tr>
                        <td> Licores </td>
                        <td> <strong> <a class="buttonlist" href="../PHP/vistaTarifaLicores.php">Mostrar</a> </strong> </td>
                    </tr>
                    <tr>
                        <td> Cigarrillos </td>
                        <td> <strong> <a class="buttonlist" href="../PHP/vistaTarifaCigarrillos.php">Mostrar</a> </strong> </td>
                    </tr>
                </tbody>
            </table>
        </section>
