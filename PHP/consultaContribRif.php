...
<head>
    ...
    <link rel="stylesheet" href="../recursos/CSS/consultaRifContrib.css">
...
<body>
    ...
    <div class="search-container">
        ...
        <form action="consultaContribRif.php" method="POST">
            ...
            <div class="container-btn">
                <!-- Enlace al archivo PHP que genera el PDF -->
                <a href="../fpdf/RifContribuyente.php" class="btn-reporte" target="_blank">Reporte</a>
            </div>
