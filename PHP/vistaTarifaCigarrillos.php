...
<body>
    ...
    <main class="tabletarifas">
            ...
            <table>
                ...
                <tr>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        try {
                            $tarifa_cigarrillos = $_POST['tarifa_cigarr'];

                            $stmt = $pdo->prepare("UPDATE tarifa_cigarrillos SET tarifa = :tarifa");
                            $stmt->bindParam(':tarifa', $tarifa_cigarrillos);
                            $stmt->execute();
        ...
        <form action="vistaTarifaCigarrillos.php" method="POST">
            <div class="user-details">
                <!-- Input para ingresar el valor nuevo -->
                <div class="input-box">
                    <label class="detail" for="nom">Actualice el valor de la tarifa</label>
                    <input type="number" step="any" placeholder=" 0.7 " name="tarifa_cigarr" id="cigarrillo" required>
                </div>
