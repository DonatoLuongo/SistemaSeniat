                    ...
                    <div class="form-container">
                        ...
                        <div class="row">
                            ...
                            <div class="TituloModulo">
                                <h3 class="lead-text"> Agregar Cigarrillos </h3>
                            </div>

                            <!-- Formulario -->
                            <form action="crudAgregarCigarrillo.php" method="POST">
                                <div class="user-details">
                                    <!-- Input para ingresar el nombre de un producto -->
                                    <div class="input-box">
                                        <label class="detail" for="nom">Nombre</label>
                                        <input type="text" placeholder="Nombre del nuevo producto" name="nombre_cigarrillo" id="cigarrillo" required>
                                    </div>
