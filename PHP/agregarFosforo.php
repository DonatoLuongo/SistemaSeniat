...
<head>
    ...
    <link rel="stylesheet" href="../recursos/CSS/MainProductos.css">
                    ...
                    <div class="form-container">
                        ...
                        <div class="row">
                            ...
                            <div class="TituloModulo">
                                <h3 class="lead-text"> Agregar Fósforo </h3>
                            </div>

                            <form action="crudAgregarFosforo.php" method="POST">
                                <div class="user-details">

                                    <div class="input-box">
                                        <label class="detail" for="labor_fosforo">Número de Labor</label>
                                        <input type="number" placeholder="9" name="labor_fosforo" id="labor_fosforo" required>
                                    </div>

                                    <div class="input-box">
                                        <label class="detail" for="tarifa_fosforo">Tarifa</label>
                                        <input type="text" placeholder="Tarifa del nuevo producto" name="tarifa_fosforo" id="tarifa_fosforo" required>
                                    </div>
                                ...
                                <div class="btn-reg">
                                    <input type="submit" value="Guardar" registrar>
                                </div>
