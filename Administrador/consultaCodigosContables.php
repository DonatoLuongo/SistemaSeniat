...
<head>
    ...
    <title> Consultas | Códigos Contables </title> <!-- Nombre de la Interfaz -->
</head>
                    ...
                    <div class="form-container">
                        ...
                        <div class="row">
                            ...
                            <div class="TituloModulos">
                                <h3 class="lead-text"> Códigos Contables </h3>
                            </div>

                            <div>
                                <a href="../Administrador/codigosContablesLicores.php">
                                    <button class="btn-consultas"><span></span>Licores</button>
                                </a>

                                <a href="../Administrador/codigoContableFosforos.php">
                                    <button class="btn-consultas"><span></span>Fósforos</button>
                                </a>

                                <a href="../Administrador/codigosContablesCigarrillos.php">
