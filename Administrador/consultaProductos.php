...
<head>
    ...
    <title> Consultas | Productos </title> <!-- Nombre de la Interfaz -->
</head>
                    ...
                    <div class="form-container">
                        ...
                        <div class="row">
                            <div class="TituloModulos">
                                <h3 class="lead-text"> Productos </h3>
                            </div>

                            <div>
                                <a href="../Administrador/consultaProducLicores.php">
                                    <button class="btn-consultas"><span></span>Licores</button>
                                </a>

                                <a href="../Administrador/consultaProducFosforos.php">
                                    <button class="btn-consultas"><span></span>Fósforos</button>
                                </a>

                                <a href="../Administrador/consultaProducCigarrillos.php">
