...
<head>
    ...
    <title> Consultas Liquidaciones | SENIAT </title> <!-- Nombre de la Interfaz -->
                ...
                <div class="col-md-12">
                    <div class="form-container">
                        ...
                        <div class="TituloModulos">
                            <h3 class="lead-text"> Liquidaciones </h3>
                        </div>

                        <div>
                            <a href="../Administrador/vistaConsultasLiquidacionLicores.php">
                                <button class="btn-consultas"><span></span>Licores</button>
                            </a>

                            <a href="../Administrador/consultaLiquidacionCigarrillos.php">
                                <button class="btn-consultas"><span></span>Cigarrillos</button>
                            </a>

                            <a href="../Administrador/consultaLiquidacionFosforos.php">
                                <button class="btn-consultas"><span></span>Fosforos</button>
                            </a>
