...
<head>
    ...
    <title> ConsultaS | Contribuyentes </title> <!-- Nombre de la Interfaz -->
</head>
                    ...
                    <div class="form-container">
                        ...
                        <div class="row">
                            <div class="TituloModulos">
                                <h3 class="lead-text"> Consulta Contribuyentes </h3>
                            </div>

                            <div>
                                <a href="../Administrador/consultaContribRif.php">
                                    <button class="btn-consultas"><span></span>RIF</button>
                                </a>
                                <a href="../Administrador/consultaListaContribuyentes.php">
                                    <button class="btn-consultas"><span></span>Listado</button>
                                </a>
                            </div>
