            ...
            <div class="row full">
                <div class="col-md-12">
                    <div class="form-container">
                        ...
                        <div>
                            <a href="../Administrador/consultaLiquidadores.php">
                                <button class="btn-consultas"><span></span>Liquidadores</button>
                            </a>

                            <a href="../Administrador/consultaContribuyente.php">
                                <button class="btn-consultas"><span></span>Contribuyentes</button>
                            </a>

                            <a href="../Administrador/consultaCodigosContables.php">
                                <button class="btn-consultas"><span></span>Código Contable</button>
                            </a>

                            <a href="../Administrador/vistaConsultasLiquidaciones.php">
                                <button class="btn-consultas"><span></span>Liquidaciones</button>
                            </a>

                            <a href="../Administrador/consultaProductos.php">
