            ...
            <table> <!--    Tabla para mostrar informacion "Datos" y la opcion de editar "Modificar"  -->
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <strong> <a class="buttonlist" href="../Administrador/vistaTarifaLicoresProduc.php">Mostrar</a> </strong> </td>
                    </tr>
                    <tr>
                        <td> Tarifas de Licores por PVP </td>
                        <td> <strong> <a class="buttonlist" href="../Administrador/vistaTarifaLicoresPVP.php">Mostrar</a> </strong> </td>
                    </tr>
                </tbody>
            </table>
        </section>
