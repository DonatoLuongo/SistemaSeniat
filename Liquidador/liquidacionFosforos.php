            ...
            <ul>
                ...
                <li><a class="linea2" href="">Liquidacion </a>
                    <ul class="barrita">
                        ...
                        <a href="../Liquidador/liquidacionFosforos.php">Fosforos</a>
                    </ul>
                </li>
        ...
        <form action="crudAgregarLiquiFosforos.php" method="post" id="miFormulario">
            ...
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="10" id="oficina">
                </div>

                <div class="form-group">
                    <label for="exampleSelect1">Gerencia</label>
                    <input type="text" placeholder="11" id="oficina">
                </div>

                <div class="form-group">
                    <label for="exampleSelect1">Número de porción</label>
                    <input type="text" placeholder="1" id="oficina">
                </div>

                <div class="form-group">
                    <label for="exampleSelect1">Tipo de liquidación</label>
                    <input type="text" placeholder="2" id="oficina">
                </div>

                <div class="form-group">
                    <label for="exampleSelect1">Serie</label>
                    <input type="text" placeholder="45" id="oficina">
                </div>
                ...
                <div class="botones-contenedor">
                    ...
                    <div class="btn-container">
                        <a href="../Liquidador/liquidacionFosfProduccion.php">
                            <input type="button" value="Producción" class="btn-enviar">
                        </a>
                    </div>

                    <div class="btn-container">
                        <a href="../Liquidador/liquidacionFosfCannon.php">
