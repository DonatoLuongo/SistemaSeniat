...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 1; $i <= 12; $i++) {
        ...
        $queryLiquidacion = "INSERT INTO liquidacion_cigarrillos 
        (idimpuesto_cigarrillos, idproductos_cigarrillos, 
        cantidad_cajetillas, precio_cajetillas, fecha_vencimiento, base_imponible, impuesto_pagar) 
        VALUES (?, ?, ?, ?, ?, ?, ?)";
