            ...
            <div class="row full">
                <div class="col-md-12">
                    <div class="form-container">
                        ...
                        <div>
                            <a href="../Liquidador/vistaConsultasLiquidacionLicores.php">
                                <button class="btn-consultas"><span></span>Licores</button>
                            </a>

                            <a href="../Liquidador/consultaLiquidacionCigarrillos.php">
                                <button class="btn-consultas"><span></span>Cigarrillos</button>
                            </a>

                            <a href="../Liquidador/consultaLiquidacionFosforos.php">
